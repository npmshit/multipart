...
const Dicer = require("./modules/dicer");
...
function Multipart(boy, cfg) {
  ...
  let parsedConType = cfg.parsedConType || [];
  let defCharset = cfg.defCharset || "utf8";
  let preservePath = cfg.preservePath;
  let fileopts =
    typeof cfg.fileHwm === "number"
      ? {
